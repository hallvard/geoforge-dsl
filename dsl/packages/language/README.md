...
- [src/geoforge.langium](src/geoforge.langium) -  The grammar definition of your language
- [src/geoforge-module.ts](src/geoforge-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/geoforge-validator.ts](src/geoforge-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/geoforge.monarch.ts](src/syntaxes/geoforge.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/geoforge.tmLanguage.json](syntaxes/geoforge.tmLanguage.json) - Textmate based syntax highlighting instructions.
